...
function rookie_header_area() {
	...
	<div class="header-area header-area-custom<?php if ( isset( $logo ) ) { ?> header-area-has-logo<?php } ?>" style="background-size: 100% 100% !important; background-image: url(<?php header_image(); ?>);">
	<?php } else { ?>
