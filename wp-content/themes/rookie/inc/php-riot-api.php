...
class riotapi {
	const API_URL_1_1 = 'https://na.api.pvp.net/api/lol/na/v1.1/';
	const API_URL_1_2 = 'https://na.api.pvp.net/api/lol/na/v1.2/';
	const API_URL_1_3 = 'https://na.api.pvp.net/api/lol/na/v1.3/';
	const API_URL_1_4 = 'https://na.api.pvp.net/api/lol/na/v1.4/';
	const API_URL_2_1 = 'https://na.api.pvp.net/api/lol/na/v2.1/';
	const API_URL_2_2 = 'https://na.api.pvp.net/api/lol/na/v2.2/';
	const API_URL_2_3 = "https://na.api.pvp.net/api/lol/na/v2.3/";
	const API_URL_2_4 = "https://na.api.pvp.net/api/lol/na/v2.4/";
	const API_URL_2_5 = "https://na.api.pvp.net/api/lol/na/v2.5/";
	const API_URL_STATIC_1_2 = 'https://global.api.pvp.net/api/lol/static-data/na/v1.2/';
	const API_URL_CURRENT_GAME_1_0 = 'https://na.api.pvp.net/observer-mode/rest/consumer/getSpectatorGameInfo/';


	const API_KEY = '8d754ff2-9023-4aa3-8996-25cfdee07029';
